...
class PaperImportGui2(object):
    def __init__(self):
        ...
        self.keyboardCallBackDict={"ESC":"Escape:27",
                              ...
                              "TAB":"",
                              "shift":"Shift_L:16"}
        self.introducionTextList=["PaperReadingAssistant\n"
...
#%%定义主窗口事件和逻辑
    ...
    def windowEventMainwindowEventMain(self):
        ...
        if not self.flagConfigFileRead==1:
            sg.popup_auto_close("配置文件读取失败，请手动添加一个工程",auto_close_duration=1,keep_on_top=True)
        else:
        ...
        while True:
            ...
            if event in ("关于"):
                tempText=""
                for i in self.introducionTextList:
                    tempText+=i
                sg.popup(tempText,title="软件介绍",keep_on_top=True,any_key_closes=True)
